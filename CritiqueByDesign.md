...
The new design aims at communicating a decline in the maternal mortality ratio in the WHO region alongside a comparison with the world. The interactive feature allows the user to select region(s) of their choice to compare and contrast or just to view a given region in isolation. Each dot on the graph gives information about the ratio in a given year. I have added the logo for WHO to give a quick insight about the data set and signal that the data is authentic. A linked source has been added in the footnotes. I have used a blue color for the lines as it signals positivity and the color shade was picked from coolor.co. 

In order to make the chart user-friendly, I incorporated the feedback from the user feedback into my design. The chart title was renamed to ‘Decline in Maternal Mortality in WHO Regions (2000 – 2017), minimized the colors and limited them to two shades, kept the line color for world different, added a footnote to give clarity about what the Y-axis stands for, and changed the scale for the X-axis.
